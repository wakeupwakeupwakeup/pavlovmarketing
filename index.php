...
<div class="wrapper">
  <div class="lang-toggle">
    <a href="" class="ru-lang-button active">RU</a>
    <div class="lang-divider"></div>
    <a href="" class="en-lang-button">ENG</a>
  </div>
  <div class="fixed-contact-button">
    <a href="" class="contact-button-wrapper">
  ...
  <main class="content-wrapper">
    <section class="welcome-section">
      <h1 class="main-offer">
        <span class="color">Повышу</span> твой доход в пару <span class="word_switch" id="word_switch">кликов</span>
      </h1>
        ...
        <div class="person-interact">
          ...
          <div class="links-wrapper">
            <a href="" class="social-link">
              <img src="img/fb_ico.png" alt="" class="social-icon">
              Facebook
            </a>
            <a href="" class="social-link">
              <img src="img/inst_ico.png" alt="" class="social-icon">
              Instagram
            </a>
            <a href="" class="social-link">
              <img src="img/tg_ico.png" alt="" class="social-icon">
              Telegram
            </a>
          </div>
        </div>
    ...
    <section class="stats-section">
      <div class="stats-wrapper">
        <div class="cell">
          <div class="projects_number" id="projects_number">0</div>
          <p class="text">Завершенных проектов</p>
        </div>
        <div class="cell">
          <div class="clients_number" id="clients_number">0</div>
          <p class="text">Новых клиентов</p>
        </div>
        <div class="cell">
          <div class="income_number" id="income_number">0</div>
      ...
      <div class="content-wrapper">
        ...
        <div class="offers-block">
          ...
          <div class="offer-wrapper">
            ...
            <div class="title-wrapper">
              <h4 class="title">Привлечение трафика</h4>
              <p class="description">Лендинги, визитки, интернет-магазины</p>
            </div>
          </div>
        </div>
    ...
    <section class="cases-section">
      ...
      <div class="uikit-slider-wrapper">
        <div uk-slider="uikit-slider center: true; autoplay: true; autoplay-interval: 2000" >
          <ul class="uk-slider-items uk-child-width-100%">
            <li>
              <div class="case">
